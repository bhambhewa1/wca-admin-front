import { Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, FormLabel, Grid, MenuItem, Select, Table, TableBody, TableCell, TableRow, TextField, Typography } from '@mui/material'
                                    ...
                                    <TableCell sx={Style.table.tableCell} align="left">
                                        <Grid container columnGap={'12px'} >
                                            <Button disableRipple sx={{
                                                backgroundColor: '#F15F23', color: 'white', '&.MuiButton-root ': {
                                                    minWidth: 0
                                                },
                                                "&.MuiButtonBase-root:hover": {
                                                    color: "white",
                                                ...
                                                onClick={handleDec}><RemoveIcon sx={{ fontsize: '18px', color: 'white' }} /></Button>
                                            <Grid xs={3}>
                                                <TextField sx={{
                                                    border: "none",
                                            ...
                                            <Button sx={{
                                                ...
                                                onClick={() => handleInc(index, data.VehicleInfomation)}><AddIcon sx={{ fontsize: '18px' }} /></Button>
                                        </Grid>
                                    </TableCell>
                                    ...
                                    <TableCell sx={Style.table.tableCell} align="left">
                                        <Grid container columnGap={'12px'} >
                                            <Button disableRipple sx={{
                                                ...
                                                onClick={() => handleDec(index, data.Documents)}><RemoveIcon sx={{ fontsize: '18px', color: 'white' }} /></Button>
                                            <Grid xs={3}>
                                                <TextField sx={{
                                                    border: "none",
                                            ...
                                            <Button sx={{
                                                ...
                                                onClick={() => handleInc(index, data.Documents)}><AddIcon sx={{ fontsize: '18px' }} /></Button>
                                        </Grid>
                                    </TableCell>
                                    <TableCell sx={Style.table.tableCell} style={{ color: row.Status === 'Complete' ? 'green' : '#F15F23' }} align="left">
                                        {row.Status}
                                    ...
                                    <TableCell sx={Style.table.tableCell} align="left">
                                        <Grid container columnGap={'12px'} >
                                            <Button disableRipple sx={{
                                                ...
                                                onClick={() => handleDec(index, data.Supervisior)}><RemoveIcon sx={{ fontsize: '18px', color: 'white' }} /></Button>
                                            <Grid xs={3}>
                                                <TextField sx={{
                                                    border: "none",
                                            ...
                                            <Button sx={{
                                                ...
                                                onClick={() => handleInc(index, data.Supervisior)}><AddIcon sx={{ fontsize: '18px' }} /></Button>
                                        </Grid>
                                    </TableCell>
                                    <TableCell sx={Style.table.tableCell} style={{ color: row.Status === 'Complete' ? 'green' : '#F15F23' }} align="left">
                                        {row.Status}
                                    ...
                                    <TableCell sx={Style.table.tableCell} align="left">
                                        <Grid container columnGap={'12px'} >
                                            <Button disableRipple sx={{
                                                ...
                                                onClick={() => handleDec(index, data.Payoff)}><RemoveIcon sx={{ fontsize: '18px', color: 'white' }} /></Button>
                                            <Grid xs={3}>
                                                <TextField sx={{
                                                    border: "none",
                                            ...
                                            <Button sx={{
                                                ...
                                                onClick={() => handleInc(index, data.Payoff)}><AddIcon sx={{ fontsize: '18px' }} /></Button>
                                        </Grid>
                                    </TableCell>
                                    <TableCell sx={Style.table.tableCell} style={{ color: row.Status === 'Complete' ? 'green' : '#F15F23' }} align="left">
                                        {row.Status}
